...
namespace RECIPE.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,type")] Recipe recipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,type")] Recipe recipe)
        {
            if (id != recipe.Id)
            {
                return NotFound();
