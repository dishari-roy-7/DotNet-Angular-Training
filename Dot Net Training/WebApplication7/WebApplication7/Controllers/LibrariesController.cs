...
namespace WebApplication7.Controllers
{
    public class LibrariesController : Controller
    {
        ...
        public LibrariesController(WebApplication7Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Library != null ? 
                          ...
                          Problem("Entity set 'WebApplication7Context.Library'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApplication7Context.Library'  is null.");
            }
            var library = await _context.Library.FindAsync(id);
            if (library != null)
            {
